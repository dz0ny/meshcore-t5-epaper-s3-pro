#include "settings_preferences.h"
#include "../ui_theme.h"
...
static void create(lv_obj_t* parent) {
    ...
    ui::nav::menu_item(list, NULL, "Display", on_display, NULL);
    ui::nav::menu_item(list, NULL, "Bluetooth", on_ble, NULL);
    ui::nav::menu_item(list, NULL, "GPS Settings", on_gps, NULL);
    ui::nav::menu_item(list, NULL, "Mesh Settings", on_mesh, NULL);
    ui::nav::menu_item(list, NULL, "Storage", on_storage, NULL);
}
