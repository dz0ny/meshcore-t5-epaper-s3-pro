 ...
 * Size: 80 px
 * Bpp: 4
 * Opts: --bpp 4 --size 80 --font .pio/libdeps/t-paper/lvgl/scripts/built_in_font/Montserrat-Medium.ttf -r 0x30-0x3A --format lvgl --lv-font-name lv_font_montserrat_ext_80 -o src/fonts/montserrat_ext_80.c --no-compress
 ******************************************************************************/
...
#ifndef LV_FONT_MONTSERRAT_EXT_80
#define LV_FONT_MONTSERRAT_EXT_80 1
#endif

#if LV_FONT_MONTSERRAT_EXT_80
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t lv_font_montserrat_ext_80 = {
#else
lv_font_t lv_font_montserrat_ext_80 = {
#endif
...
#endif /*#if LV_FONT_MONTSERRAT_EXT_80*/
