 ...
 * Size: 120 px
 * Bpp: 4
 * Opts: --bpp 4 --size 120 --font /tmp/Montserrat-Bold.ttf -r 0x30-0x3A --format lvgl --lv-font-name lv_font_montserrat_bold_120 -o src/fonts/montserrat_bold_120.c --no-compress
 ******************************************************************************/
