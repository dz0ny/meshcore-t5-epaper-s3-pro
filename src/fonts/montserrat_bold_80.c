 ...
 * Size: 80 px
 * Bpp: 4
 * Opts: --bpp 4 --size 80 --font /tmp/Montserrat-Bold.ttf -r 0x30-0x3A --format lvgl --lv-font-name lv_font_montserrat_bold_80 -o src/fonts/montserrat_bold_80.c --no-compress
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 869, .box_w = 49, .box_h = 59, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 1446, .adv_w = 502, .box_w = 25, .box_h = 57, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2159, .adv_w = 755, .box_w = 45, .box_h = 57, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 3442, .adv_w = 758, .box_w = 46, .box_h = 58, .ofs_x = -1, .ofs_y = -1},
    {.bitmap_index = 4776, .adv_w = 882, .box_w = 53, .box_h = 57, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 6287, .adv_w = 762, .box_w = 46, .box_h = 58, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 7621, .adv_w = 815, .box_w = 47, .box_h = 59, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 9008, .adv_w = 794, .box_w = 45, .box_h = 57, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 10291, .adv_w = 845, .box_w = 48, .box_h = 59, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 11707, .adv_w = 815, .box_w = 47, .box_h = 59, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 13094, .adv_w = 335, .box_w = 17, .box_h = 45, .ofs_x = 2, .ofs_y = -1}
};
...
{
    -5, -5, -13, -5, -13, -6, -6, -13,
    -12, -32, -9, -54, 13, -5, 10, -6,
    -6, -6, -15, -5, -26, 13, -9, -83,
    -22, -26, -22, -26, -5, -5, -13, -5,
    5
};
